...
public class Naryn extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_naryn, container, false);
        // menchiktoolor
        ...
        // maalymattardy aluu
        Call<Example2> listCall = apiTemp.getData("Naryn%20Kyrgyzstan");
