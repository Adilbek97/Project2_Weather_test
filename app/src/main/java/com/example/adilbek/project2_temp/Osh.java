...
import com.example.adilbek.project2_temp.api.ApiOsh;
...
public class Osh extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_osh, container, false);
        ...
        ApiOsh apiTemp = retrofit.create(ApiOsh.class);
