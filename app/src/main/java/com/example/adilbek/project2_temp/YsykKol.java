...
import com.example.adilbek.project2_temp.api.ApiYssykKol;
...
public class YsykKol extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_ysyk_kol, container, false);
        ...
        ApiYssykKol apiTemp = retrofit.create(ApiYssykKol.class);
